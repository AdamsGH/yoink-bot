...
import type { DownloadLog, PaginatedResponse, RetryResponse } from '@/types/api'
...
function ExpandedRow({ item }: { item: DownloadLog }) {
  ...
  const retry = async (e: React.MouseEvent) => {
    ...
    setRetrying(true)
    try {
      await apiClient.post<RetryResponse>(`/downloads/${item.id}/retry`)
...
export default function HistoryPage() {
  ...
  useEffect(() => {
    ...
    apiClient
      .get<PaginatedResponse<DownloadLog>>('/downloads', { params })

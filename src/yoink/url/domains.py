"""Domain classification lists. All lists configurable via Settings."""
...
@dataclass
class DomainConfig:
    """All domain lists in one place. Populated from Settings at startup."""
    ...
    @classmethod
    def from_settings(cls, settings: "Settings") -> "DomainConfig":
        return cls(
            proxy_domains=settings.proxy_domains,
            proxy_2_domains=settings.proxy_2_domains,
        )

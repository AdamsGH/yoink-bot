...
from yoink.bot.middleware import get_settings, get_user_repo
...
async def _cmd_list(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    if not url.startswith(("http://", "https://")):
        await update.message.reply_html("❌ Please provide a valid URL.")
        return

...
from yoink.bot.middleware import get_settings
from yoink.services.cookies import CookieManager, validate_netscape, _domain_from_url
...
async def _handle_document(msg: object, user_id: int, args: list, mgr: CookieManager) -> None:
    ...
    tmp = Path(tempfile.mktemp(suffix=".txt", prefix="ck_upload_"))
    try:
